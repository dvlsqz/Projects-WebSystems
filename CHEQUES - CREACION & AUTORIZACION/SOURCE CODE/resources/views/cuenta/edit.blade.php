...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Cuenta: {{$cuenta->no_cuenta}}</h3>
			@if(count($errors)>0)
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="no_cuenta" required value="{{$cuenta->no_cuenta}}" class="form-control" placeholder="Numero de la Cuenta...">
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="saldo" required value="{{$cuenta->saldo}}" class="form-control" placeholder="Saldo de la Cuenta en Q....">
					</div>
				</div>
			</div>
