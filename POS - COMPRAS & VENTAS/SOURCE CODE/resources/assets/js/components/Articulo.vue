                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="codigo" class="form-control" placeholder="Codgio de Barras">
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            cargarPdf(){
                window.open('http://127.0.0.1:8000/articulo/listarPdf','blank');
            },
            selectCategoria(){
                let me=this;
            ...
            validarArticulo(){
                ...
                if (!this.precio_venta) this.errorMostrarMsjArticulo.push("El precio del articulo no puede estar vacío.");
